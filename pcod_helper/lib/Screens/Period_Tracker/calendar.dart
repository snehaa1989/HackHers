import 'dart:core';
import 'package:pcod_helper/Screens/Period_Tracker/Tracker_Initializer.dart';
...
class _CalendarState extends State<Calendar> {
      ...
      child: Container(
          ...
          child: Row(
              ...
              children:[Text(d,
                ...
                IconButton(icon: FaIcon(FontAwesomeIcons.trashAlt, color: Colors.purple, size: 15,), onPressed: ()=> _deleteEvent(d))
              ]) ),
    );  }
  ...
  Widget eventTitle(){
    ...
    return Container(
      padding: EdgeInsets.fromLTRB(15, 20, 15, 15),
      child:Text("Log Period", style: Theme.of(context).primaryTextTheme.headline1),
    );
  }
